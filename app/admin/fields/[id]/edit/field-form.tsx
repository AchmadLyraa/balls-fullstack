...
import { updateField } from "@/app/actions/admin";
...
interface FieldFormProps {
  fieldId: string;
  field: Pick<Field, "name" | "description" | "capacity" | "hourlyRate">;
}

export default function FieldForm({ fieldId, field }: FieldFormProps) {
  ...
  const onSubmit = async (data: Form) => {
    ...
    try {
      const result = await updateField(fieldId, data);
      ...
      toast.error(`Failed to edit field. Please try again later`);
    } finally {
      setIsLoading(false);
    }
  };
