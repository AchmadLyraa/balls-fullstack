  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Welcome back, {user.username}! Here's an overview of your system.</p>
      </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>Latest field bookings across all fields</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    <div className="space-y-1">
                      <p className="text-sm font-medium leading-none">Field A - SRE Team</p>
                      <p className="text-sm text-muted-foreground">12/05/2025 - Rp 450,000</p>
                    </div>
                    <div className="ml-auto font-medium">Confirmed</div>
                  </div>
                  <div className="flex items-center">
                    <div className="space-y-1">
                      <p className="text-sm font-medium leading-none">Field B - AUROBOROS</p>
                      <p className="text-sm text-muted-foreground">15/06/2025 - Rp 550,000</p>
                    </div>
                    <div className="ml-auto font-medium">Pending</div>
                  </div>
                  <div className="flex items-center">
                    <div className="space-y-1">
                      <p className="text-sm font-medium leading-none">Field A - ENGGANG</p>
                      <p className="text-sm text-muted-foreground">25/09/2025 - Rp 250,000</p>
                    </div>
            ...
            <Card className="col-span-3">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center">
                    <div className="space-y-1">
                      <p className="text-sm font-medium leading-none">Field A (North Wing)</p>
                  ...
                  <div className="flex items-center">
                    <div className="space-y-1">
                      <p className="text-sm font-medium leading-none">Field B (South Wing)</p>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="text-sm font-medium leading-none">April 2025 Report</p>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="text-sm font-medium leading-none">March 2025 Report</p>
