    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Borneo Anfield Stadium - Your one-stop solution for field booking and loyalty rewards.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-2">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Book your preferred field and time slot</p>
            <div className="mt-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Loyalty Rewards</CardTitle>
            <CreditCard className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">Check Rewards</div>
            <p className="text-xs text-muted-foreground">View your loyalty points and available rewards</p>
            <div className="mt-4">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Check your booking history and upcoming reservations</p>
            <div className="mt-4">
