      ...
      <Card>
        <CardContent className="p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500">Your booking has been received and is pending confirmation</p>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-yellow-600">{bookingData.status}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 p-4 rounded-lg mb-6 border border-blue-100">
            <p className="text-blue-800 text-sm">
              <strong>Note:</strong> Your booking will be confirmed once the payment is verified. You will receive a
              notification when your booking is confirmed.
            </p>
          </div>
